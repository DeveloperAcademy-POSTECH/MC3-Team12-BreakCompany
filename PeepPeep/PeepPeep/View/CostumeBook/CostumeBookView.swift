...
//    @State private var isSheet = false
    ...
    var body: some View {
        ...
        .onAppear{
            selectNum = costumeNames.firstIndex(of: UserDefaults.shared.string(forKey: "selectedCostume") ?? "Classic") ?? 0
        }
    }
    ...
    var body: some View {
        ...
        VStack {
            ...
            Button {
                selectCell()
                isSheet = false
                UserDefaults.shared.set(cell.imageName, forKey: "selectedCostume")
            } label: {
                Text("선택")
                    .font(.custom("DOSSaemmul", size: 20))
